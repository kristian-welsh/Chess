package pieces {
	...
	public class ChessPiece extends MovieClip implements IChessPiece {
		...
		protected function nonDiagonalMovement(limit:int):Vector.<Point> {
		...
		protected function diagonalMovement(limit:int):Vector.<Point> {
			var returnMe:Vector.<Point> = new Vector.<Point>()
			for (var i:uint = 1; i < limit + 1; i++) {
		...
		public function legalMoves():Vector.<Point> {
